...
!!! tip "Самый короткий путь"
    Если цель - просто собрать итоговый PDF, установите Task и Docker, затем выполните команды из раздела [Быстрый старт](/quick-start/).
...
| --- | --- |
| Собрать итоговый PDF | [Быстрый старт](/quick-start/) |
| Собрать без Docker | [Сборка без Docker](/manual-build/) |
| Настроить TeXstudio | [Настройка TeXstudio](/texstudio/) |
| Пересобрать титульник и задание | [Титульник и задание](/title-pages/) |
| Пересобрать диаграммы | [Диаграммы](/diagrams/) |
| Подключить код приложения | [Код в приложениях](/source-code/) |
| Сравнить PDF между коммитами | [Сравнение PDF между коммитами](/pdf-diff/) |
| Настроить резервное копирование | [Резервное копирование](/backup/) |
| Разобрать ошибку сборки | [Проблемы с компиляцией](/troubleshooting/) |
| Проверить CI/CD и релизные артефакты | [CI/CD и релизы](/ci/) |
