...
!!! info "Что нужно установить"
    Если вы впервые открыли проект, начните с [Что нужно установить](/requirements/). Там кратко перечислены инструменты для Docker-сборки, локальной сборки и сравнения PDF.

!!! tip "Если уже знаете, что хотите сделать"
    Откройте [Частые сценарии](/common-scenarios/): там коротко расписаны сборка PDF, обновление диаграмм и титульных страниц, подключение кода и сравнение версий.
