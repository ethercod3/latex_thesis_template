...
!!! tip "Если уже знаете, что хотите сделать"
    Откройте [Частые сценарии](common-scenarios.md): там коротко расписаны сборка PDF, обновление диаграмм и титульных страниц, разделение PDF на цветные/ЧБ страницы, подключение кода и сравнение версий.
