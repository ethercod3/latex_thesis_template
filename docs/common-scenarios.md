...
Эта страница помогает выбрать короткий путь, если не нужно читать всю документацию подряд.
...
После сборки итоговый PDF появится в корне проекта. Если команда падает, переходите к разделу [Проблемы с компиляцией](/troubleshooting/).
...
После обновления диаграмм пересоберите основной PDF. Подробности: [Диаграммы](/diagrams/).
...
Если пустые страницы нужно сохранить, используйте `task docx:keep-blank`. Подробности: [Титульник и задание](/title-pages/).
...
Подробности: [Код в приложениях](/source-code/).
...
Подробности: [Сравнение PDF между коммитами](/pdf-diff/).
...
Подробности: [Документация](/zensical/).
