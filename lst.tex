...
\newcommand{\calloutfullreffootnote}[1]{%
  \footnote{
  Метка \codecalloutref{#1}, листинг~\codecalloutlistingref{#1}, приложение~\listingsappendix{}, с.~\pageref{#1}
  }%
}
...
%\definecolor{bg}{RGB}{250,250,250}
%\definecolor{kw}{RGB}{0,102,204}
%\definecolor{str}{RGB}{153,0,0}
%\definecolor{com}{RGB}{102,153,102}
...
\lstdefinestyle{bashcommand}{
    backgroundcolor=\color{bg},
    basicstyle=\listingmono\small\color{text},
    keywordstyle=\bfseries,
    commentstyle=\color{com}\itshape,
    stringstyle=\color{str},
    numbers=none,
